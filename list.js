...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    chrome.storage.sync.get({savedURLs: []}, function(data) {
        var allURLs = data.savedURLs;
        for (var item in allURLs) { // can't do all this in the same loop as above as the btn obj isn't created completely til the loop ends
